import { M as ie } from "./scheduler.C-0YFhF0.js";
import { w as pt } from "./index.BqH4I7s2.js";
...
window.fetch = (t, n) => (
  (t instanceof Request
    ? t.method
    : (n == null ? void 0 : n.method) || "GET") !== "GET" && M.delete(gt(t)),
  $t(t, n)
);
const M = new Map();
function ye(t, n) {
  ...
  if (a != null && a.textContent) {
    ...
    return (
      i && M.set(e, { body: r, init: o, ttl: 1e3 * Number(i) }),
...
var jt;
const P =
  ((jt = globalThis.__sveltekit_2b9t9a) == null ? void 0 : jt.base) ?? "";
var Dt;
const Re =
    ((Dt = globalThis.__sveltekit_2b9t9a) == null ? void 0 : Dt.assets) ?? P,
  Ie = "1716772987824",
...
async function en(t, n, e) {
  ...
  document.URL !== location.href && (location.href = location.href),
    ...
    (L = (o = history.state) == null ? void 0 : o[G]),
    S ||
      ((S = L = Date.now()),
    ...
    q.add(n),
      (R = {
        ...
        promise: te({ ...t, preload: n }).then(
          (e) => (
            q.delete(n), e.type === "loaded" && e.state.error && (R = null), e
          ),
        ),
      });
  }
...
async function te({
  ...
  if ((R == null ? void 0 : R.id) === t) return q.delete(R.token), R.promise;
...
async function Y({
  ...
  if (((R = null), (l.props.page.state = i), Q)) {
    ...
    const w = (await Promise.all(Ge.map((p) => p(g.navigation)))).filter(
      (p) => typeof p == "function",
    );
    if (w.length > 0) {
      let p = function () {
